...
let currentVersion = _semver2.default.clean(process.version);
...
function polyfill(targetVersion, object, methods) {
  if (!_semver2.default.satisfies(currentVersion, targetVersion)) {
    return;
  }
...
polyfill('<5.10.0', Buffer, {
  from: function () {
    ...
    if (arguments[0] instanceof ArrayBuffer) {
      if (_semver2.default.lt(currentVersion, '5.4.0')) {
    ...
    if (arguments[0] instanceof Buffer) {
      if (_semver2.default.gte(currentVersion, '0.11.15')) {
        return new Buffer(arguments[0]);
      }
  ...
  alloc: function () {
    ...
    if (encoding && supportedEncoding.indexOf(encoding)) {
      ...
      if (_semver2.default.gte(currentVersion, '5.7.0')) {
